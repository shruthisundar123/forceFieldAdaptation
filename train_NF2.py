...
def train_NF2(trialNumber, folderLocation):
    ##############################
    print()
    ...
    weight_file = "new500UnitNetwork/save_CF1" + os.path.sep + "weights_" + trialNumber + ".h5"
    ...
    n_t = 100
    n_batches = 1 #256
    batch_size = 32 #change to 1 when actually adapting to represent human learning more
